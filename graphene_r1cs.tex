...
$\wit_x,\wit_y,\wit_z$ and $\wit$ as $p\times m\times n$ matrices. Let $\bwit$
denote the $4p\times m\times n$ matrix formed by stacking $\wit_x,\wit_y,\wit_z$
...
We now summarize several performance parameters attained by $\name$, for circuit
