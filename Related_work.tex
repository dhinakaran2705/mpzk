...
Table \ref{tab:SPZK} captures the summary. \commentA{there is no explanation why other protocols are not compared in the table. explian why alone DP-bulletproof is compared. what is E in the table? Protik: stop leaving undefined symbols}
