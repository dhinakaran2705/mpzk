...
\begin{table*}[htb!] 
	...
	\caption{Comparison amongst the DPZKs \commentA{E is meant to stay outside order?} \pnote{As described above, E is the cost (time) of single exponentiation. That is why E is outside of order}}\label{tab:SPZK}
	%\pnote{Con}
\end{table*}
