...
sets $F_1,F_2$ may be
determined using algorithms for decoding Reed Solomon codes. From Lemma ~\ref{lem:bicdecoding}, it follows that for all $i\in [p]$, there exists $U^i\in L_1\otimes L_2$ such
