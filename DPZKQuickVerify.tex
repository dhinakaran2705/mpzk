...
\noindent{\bf Distributed Proximity Test}: The provers jointly prove that the
...
\noindent{\bf Distributed Membership Test}: This protocol reduces to each prover
...
\noindent{\bf Distributed Linear Test}: We provide the complete distributed
...
\noindent{\bf Distributed Quadratic Check}: This is the only protocol whose
