...
For code $\rsc{\eta}{n,\ell}$, let $\Lambda_{n,\ell}$ denote the matrix for the linear transformation that maps a vector $x\in \FF^\ell$ 
...
parity-check matrices as   $\mac{H}_{n,\ell},\mc{H}_{h,m},\mc{H}_{n,s+\ell},\mc{H}_{n,2\ell}$. 
